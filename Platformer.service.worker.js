...
/** @type {string} */
const CACHE_VERSION = '1737769945|2690168692';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["Platformer.html","Platformer.js","Platformer.offline.html","Platformer.icon.png","Platformer.apple-touch-icon.png","Platformer.worker.js","Platformer.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Platformer.wasm","Platformer.pck"];
